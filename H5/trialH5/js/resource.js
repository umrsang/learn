...
resources.btn_clothesType = [
    ['btn_hair', '/img/clothing/btn_hair.png?v=2018092102'],
    ['btn_acc', '/img/clothing/btn_acc.png?v=2018092102'],
    ['btn_dress', '/img/clothing/btn_dress.png?v=2018092102'],
    ['btn_shoes', '/img/clothing/btn_shoes.png?v=2018092102'],
]
resources.btn_hair = [
    ['btn_hair_1', '/img/clothing/btn_hair_1.png', {color: 'blue', style: 'sexy', back: 'hair_1_b'}],
...
resources.hair = [
    ...
    ['hair_1_b', '/img/clothing/hair_1_b.png'],
]
resources.btn_shoes = [
